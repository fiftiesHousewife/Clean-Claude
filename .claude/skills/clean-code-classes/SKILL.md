...
description: Apply when fixing class-design findings from the Clean Code plugin — Ch10.1 (classes should be small), Ch10.2 (SRP), G8 (too much information), G14 (feature envy), G17 (misplaced responsibility), G18 (inappropriate static). Use when the user asks to split a class, move a method between classes, or reduce class size.
---
