...
**Self-analysis summary (auto-generated):** [docs/reports/index.html](https://htmlpreview.github.io/?https://github.com/fiftiesHousewife/Clean-Claude/blob/main/docs/reports/index.html) — per-module counts, totals, and links to each detailed HTML report. Regenerated by `./gradlew cleanCodeSummary` (root project only) so the README never drifts out of sync.
