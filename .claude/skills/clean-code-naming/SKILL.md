...
description: Apply when fixing naming findings from the Clean Code plugin — N1 (descriptive names), N5 (long names for long scopes), N6 (avoid encodings), N7 (names should describe side effects), G11 (inconsistency), G16 (obscured intent). Use when the user asks to rename a class/method/field or eliminate abbreviations, Hungarian notation, or nested ternaries.
---
