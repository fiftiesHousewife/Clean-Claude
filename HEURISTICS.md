...
**Detection:** [ObsoleteCommentRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/ObsoleteCommentRecipe.java) — detects comments referring to parameters or methods that no longer exist.
...
**Detection:** [MumblingCommentRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/MumblingCommentRecipe.java) — detects comments that restate the method name or parameter names.
...
**Detection:** [CommentedCodeRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/CommentedCodeRecipe.java) — detects commented-out code blocks.
**Skill file:** [clean-code-comments-and-clutter](.claude/skills/clean-code-comments-and-clutter/SKILL.md)
...
**Detection:** [LargeConstructorRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/LargeConstructorRecipe.java) — detects constructors with too many parameters. [(refactoring) RecordToLombokValueRecipe](refactoring/src/main/java/io/github/fiftieshousewife/cleancode/refactoring/RecordToLombokValueRecipe.java) — rewrites wide records as Lombok `@Value` classes with a builder. Also Checkstyle `ParameterNumber` check (threshold: 4).
...
**Detection:** [OutputArgumentRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/OutputArgumentRecipe.java) — detects methods that mutate collection arguments. [InconsistentReturnRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/InconsistentReturnRecipe.java) — detects methods that sometimes return a value and sometimes mutate state.
**Skill file:** [clean-code-functions](.claude/skills/clean-code-functions/SKILL.md)
...
**Detection:** [EmbeddedLanguageRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/EmbeddedLanguageRecipe.java) — detects inline SQL, HTML, JSON, or other embedded languages in Java string literals.
...
**Detection:** [UncheckedCastRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/UncheckedCastRecipe.java) — detects `@SuppressWarnings("unchecked")`. [SuppressedWarningRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/SuppressedWarningRecipe.java) — detects broad `@SuppressWarnings` usage. [SwallowedExceptionRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/SwallowedExceptionRecipe.java) — detects empty catch blocks. [SystemOutRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/SystemOutRecipe.java) — detects `System.out`/`System.err`/`printStackTrace` calls. Also PMD `EmptyCatchBlock` and SpotBugs `DE_MIGHT_IGNORE`.
...
**Detection:** [BaseClassDependencyRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/BaseClassDependencyRecipe.java) — detects base classes that reference or `instanceof`-test their subclasses.
...
**Detection:** [VisibilityReductionRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/VisibilityReductionRecipe.java) — detects public mutable fields. Also PMD `ExcessivePublicCount`, `CouplingBetweenObjects`, `TooManyFields`.
...
**Detection:** [VerticalSeparationRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/VerticalSeparationRecipe.java) — detects declarations more than 10 lines from first use (configurable). [(refactoring) MoveDeclarationRecipe](refactoring/src/main/java/io/github/fiftieshousewife/cleancode/refactoring/MoveDeclarationRecipe.java) — moves declarations closer to their first use.
**Skill file:** [clean-code-comments-and-clutter](.claude/skills/clean-code-comments-and-clutter/SKILL.md)
...
**Detection:** [InconsistentNamingRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/InconsistentNamingRecipe.java) — detects mixed verb prefixes (get/fetch/retrieve, create/make/build, remove/delete) in the same class.
...
**Detection:** [ArtificialCouplingRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/ArtificialCouplingRecipe.java) — detects constants or helpers placed in classes unrelated to their purpose.
...
**Detection:** [FeatureEnvyRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/FeatureEnvyRecipe.java) — detects methods where external calls exceed double the self calls.
**Skill file:** [clean-code-classes](.claude/skills/clean-code-classes/SKILL.md)
...
**Detection:** [SelectorArgumentRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/SelectorArgumentRecipe.java) — detects enum or string selector parameters used to switch behaviour. See also F3 (Flag Arguments).
...
**Detection:** [NestedTernaryRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/NestedTernaryRecipe.java) — detects ternary expressions nested inside other ternaries. [(refactoring) RemoveNestedTernaryRecipe](refactoring/src/main/java/io/github/fiftieshousewife/cleancode/refactoring/RemoveNestedTernaryRecipe.java) — rewrites nested ternaries as if/else blocks.
**Skill file:** [clean-code-naming](.claude/skills/clean-code-naming/SKILL.md)
...
**Detection:** [InappropriateStaticRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/InappropriateStaticRecipe.java) — detects static methods that should be instance methods. Also PMD analysis mapped via adapter.
**Skill file:** [clean-code-classes](.claude/skills/clean-code-classes/SKILL.md)
...
**Detection:** [(refactoring) AddFinalRecipe](refactoring/src/main/java/io/github/fiftieshousewife/cleancode/refactoring/AddFinalRecipe.java) — adds `final` to local variables and parameters that are never reassigned. Also Checkstyle `FinalLocalVariable`.
**Skill file:** [clean-code-comments-and-clutter](.claude/skills/clean-code-comments-and-clutter/SKILL.md)
...
**Detection:** [SwitchOnTypeRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/SwitchOnTypeRecipe.java) — detects `instanceof` chains. [StringSwitchRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/StringSwitchRecipe.java) — detects String switch with 3+ cases. [StringlyTypedDispatchRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/StringlyTypedDispatchRecipe.java) — detects methods that dispatch on a string label parameter.
**Skill file:** [clean-code-conditionals-and-expressions](.claude/skills/clean-code-conditionals-and-expressions/SKILL.md)
...
**Detection:** [LegacyFileApiRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/LegacyFileApiRecipe.java) — detects `java.io.File`/`FileInputStream`/`FileOutputStream` usage that should migrate to `java.nio.file`. [RawGenericRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/RawGenericRecipe.java) — detects raw generic types. [(refactoring) AddLocaleRecipe](refactoring/src/main/java/io/github/fiftieshousewife/cleancode/refactoring/AddLocaleRecipe.java) — adds `Locale.ROOT` to case-conversion calls. Also SpotBugs `DM_BOXED_PRIMITIVE_FOR_COMPARE`.
**Skill file:** [clean-code-java-idioms](.claude/skills/clean-code-java-idioms/SKILL.md)
...
**Detection:** [NegativeConditionalRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/NegativeConditionalRecipe.java) — detects double negation patterns. [GuardClauseRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/GuardClauseRecipe.java) — detects negated conditions wrapping the method body that should be inverted into guard clauses.
**Fix:** [InvertNegativeConditionalRecipe](refactoring/src/main/java/io/github/fiftieshousewife/cleancode/refactoring/InvertNegativeConditionalRecipe.java) — rewrites `if (!cond) A else B` as `if (cond) B else A` when the condition is a unary `!` and an else branch exists.
**Skill file:** [clean-code-conditionals-and-expressions](.claude/skills/clean-code-conditionals-and-expressions/SKILL.md)
...
**Detection:** [TemporalCouplingRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/TemporalCouplingRecipe.java) — detects methods whose call order is implicitly required but not enforced by types.
...
**Detection:** [BoundaryConditionRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/BoundaryConditionRecipe.java) — detects raw `+1`/`-1` adjustments on method calls. [(refactoring) EncapsulateBoundaryRecipe](refactoring/src/main/java/io/github/fiftieshousewife/cleancode/refactoring/EncapsulateBoundaryRecipe.java) — extracts boundary adjustments into named local variables.
**Skill file:** [clean-code-conditionals-and-expressions](.claude/skills/clean-code-conditionals-and-expressions/SKILL.md)
...
**Detection:** [SectionCommentRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/SectionCommentRecipe.java) — detects section comment banners inside methods.
**Skill file:** [clean-code-functions](.claude/skills/clean-code-functions/SKILL.md)
...
**Detection:** [ConfigurableDataRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/ConfigurableDataRecipe.java) — detects configuration-like constants buried in low-level classes. [HardcodedListRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/HardcodedListRecipe.java) — detects hardcoded lists of values that should be externalised.
**Fix:** [ExtractClassConstantRecipe](refactoring/src/main/java/io/github/fiftieshousewife/cleancode/refactoring/ExtractClassConstantRecipe.java) — promotes repeated numeric literals (≥N occurrences) to `private static final` fields at class scope.
...
**Detection:** [InheritConstantsRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/InheritConstantsRecipe.java) — detects classes implementing constant-only interfaces.
**Skill file:** [clean-code-java-idioms](.claude/skills/clean-code-java-idioms/SKILL.md)
...
**Detection:** [EnumForConstantsRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/EnumForConstantsRecipe.java) — detects groups of static final fields that share a prefix.
**Skill file:** [clean-code-java-idioms](.claude/skills/clean-code-java-idioms/SKILL.md)
...
**Detection:** [BadClassNameRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/BadClassNameRecipe.java) — detects class names with vague suffixes (Helper, Util, Manager, Processor). Also Checkstyle `LocalVariableName`, `MethodName`, `TypeName`.
**Skill file:** [clean-code-naming](.claude/skills/clean-code-naming/SKILL.md)
...
**Detection:** [ShortVariableNameRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/ShortVariableNameRecipe.java) — detects single-letter names outside loops and lambdas (configurable).
**Fix:** [RenameShortNameRecipe](refactoring/src/main/java/io/github/fiftieshousewife/cleancode/refactoring/RenameShortNameRecipe.java) — takes a user-supplied `Map<String, String>` of old → new names and renames variables (and their usages) outside for / for-each loop control scopes.
**Skill file:** [clean-code-naming](.claude/skills/clean-code-naming/SKILL.md)
...
**Detection:** [EncodingNamingRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/EncodingNamingRecipe.java) — detects Hungarian notation and type prefixes.
**Skill file:** [clean-code-naming](.claude/skills/clean-code-naming/SKILL.md)
...
**Detection:** [SideEffectNamingRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/SideEffectNamingRecipe.java) — detects methods named get/is/has that contain assignments.
**Skill file:** [clean-code-naming](.claude/skills/clean-code-naming/SKILL.md)
...
**Detection:** [MultipleAssertRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/MultipleAssertRecipe.java) — detects tests with 3+ independent assertions that should be wrapped in `assertAll`. [PrivateMethodTestabilityRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/PrivateMethodTestabilityRecipe.java) — detects non-trivial private methods that should be package-private for direct testing. [(refactoring) WrapAssertAllRecipe](refactoring/src/main/java/io/github/fiftieshousewife/cleancode/refactoring/WrapAssertAllRecipe.java) — wraps adjacent assertions in `assertAll`. [(refactoring) ReduceVisibilityRecipe](refactoring/src/main/java/io/github/fiftieshousewife/cleancode/refactoring/ReduceVisibilityRecipe.java) — reduces private helpers to package-private so they can be tested. Also JaCoCo line coverage analysis.
...
**Detection:** [DisabledTestRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/DisabledTestRecipe.java) — detects `@Disabled`/`@Ignore` without meaningful reason.
...
**Detection:** [DisabledTestRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/DisabledTestRecipe.java).
...
**Detection:** [PrivateMethodTestabilityRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/PrivateMethodTestabilityRecipe.java) — detects non-trivial private methods that should be package-private for testing. [(refactoring) ReduceVisibilityRecipe](refactoring/src/main/java/io/github/fiftieshousewife/cleancode/refactoring/ReduceVisibilityRecipe.java) — reduces private methods to package-private so they can be tested directly.
**Skill file:** [clean-code-functions](.claude/skills/clean-code-functions/SKILL.md)
...
**Detection:** [CatchLogContinueRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/CatchLogContinueRecipe.java) — detects catch blocks that only log or are empty. [BroadCatchRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/BroadCatchRecipe.java) — detects catches of overly broad types like `Exception` or `Throwable`.
...
**Detection:** [NullDensityRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/NullDensityRecipe.java) — detects methods with 3+ null checks (configurable). Also SpotBugs redundant null check detection.
...
**Detection:** [ClassLineLengthRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/ClassLineLengthRecipe.java) — detects classes exceeding 150 lines (configurable).
**Skill file:** [clean-code-classes](.claude/skills/clean-code-classes/SKILL.md)
...
**Detection:** [LargeRecordRecipe](recipes/src/main/java/io/github/fiftieshousewife/cleancode/recipes/LargeRecordRecipe.java) — detects records with 6+ components (configurable).
**Skill file:** [clean-code-classes](.claude/skills/clean-code-classes/SKILL.md)
